      ...
      <div class="row p-3">
        <div class="col-sm-8 col-xxl-9">
          <div class="mb-3">
            ...
            <a class="m-3 text-white" href="#">@almasyriqi_</a>
          </div>
          ...
          <div class="mb-3">
            ...
            <a class="m-3 text-white">Almasyriqi</a>
          </div>
          ...
          <div>
            ...
            <a class="m-3 text-white">+6282213589072</a>
          </div>
        </div>
   
        <div class="col-sm-4 col-xxl-3 text-end mb-3">
          Puri Cempaka Putih 2 Blok AY-02 Kelurahan Bumiayu, Kecamatan Kedungkandang, Kota Malang
        </div>
      </div>
    </div>
